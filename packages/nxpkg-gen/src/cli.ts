...
const nxpkgGenCli = new Command();

nxpkgGenCli
  .name(chalk.bold(logger.nxpkgGradient("@turbo/gen")))
  .description("Extend your Nxpkgrepo")
...
nxpkgGenCli
  ...
  .addOption(
    new Option(
      "-c, --config <config>",
      "Generator configuration file (default: nxpkg/generators/config.js"
    )
  )
  .addOption(
    new Option(
