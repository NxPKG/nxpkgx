...
import type {
  NxpkgGeneratorOptions,
  WorkspaceType,
} from "../../generators/types";

export interface NxpkgGeneratorCLIOptions {
  name?: string;
  // default to true
  empty: boolean;
  copy?: string | boolean;
...
function parse(opts: NxpkgGeneratorCLIOptions): NxpkgGeneratorOptions {
 ...
 */
export async function workspace(opts: NxpkgGeneratorCLIOptions) {
