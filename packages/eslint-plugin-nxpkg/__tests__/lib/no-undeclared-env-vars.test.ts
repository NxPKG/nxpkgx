  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "ENV_3 is not listed as a dependency in the root nxpkg.json or workspace (apps/web) nxpkg.json",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "ENV_2 is not listed as a dependency in the root nxpkg.json or workspace (apps/docs) nxpkg.json",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message:
            "NEXT_PUBLIC_EXCLUDE is not listed as a dependency in the root nxpkg.json or workspace (apps/web) nxpkg.json",
        },
        {
          message:
            "NEXT_PUBLIC_EXCLUDED is not listed as a dependency in the root nxpkg.json or workspace (apps/web) nxpkg.json",
        },
      ],
    },
    {
      ...
      errors: [{ message: "X is not listed as a dependency in nxpkg.json" }],
    },
    {
      ...
      errors: [
        { message: "X is not listed as a dependency in nxpkg.json" },
        { message: "Y is not listed as a dependency in nxpkg.json" },
        { message: "Z is not listed as a dependency in nxpkg.json" },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "NOT_THERE is not listed as a dependency in nxpkg.json",
        },
      ],
    },
    {
      ...
      errors: [{ message: "KEY is not listed as a dependency in nxpkg.json" }],
    },
    {
      code: `
      ...
      errors: [
        {
          message:
            "TASK_ENV_KEY_NEW is not listed as a dependency in nxpkg.json",
        },
        {
          message:
            "GLOBAL_ENV_KEY_NEW is not listed as a dependency in nxpkg.json",
        },
        {
          message: "ENV_VAR_ONE is not listed as a dependency in nxpkg.json",
        },
        {
          message: "ENV_VAR_TWO is not listed as a dependency in nxpkg.json",
        },
      ],
    },
    {
      ...
      errors: [
        ...
        {
          message:
            "ENV_VAR_NOT_ALLOWED is not listed as a dependency in nxpkg.json",
        },
      ],
    },
    {
