...
const createNxpkgCli = new Command();

// create
createNxpkgCli
  .name(chalk.bold(logger.nxpkgGradient("create-nxpkg")))
  .description("Create a new Nxpkgrepo")
  ...
  .option(
    "--nxpkg-version <version>",
    "Use a specific version of nxpkg (default: latest)"
  )
  .option(
    "-e, --example [name]|[github-url]",
    `
  An example to bootstrap the app with. You can use an example name
  from the official Nxpkgrepo repo or a GitHub URL. The URL can use
