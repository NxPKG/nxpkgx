...
describe("examples", () => {
  describe("isUrlOk", () => {
    it("returns true if url returns 200", async () => {
      ...
      const url = "https://github.com/nxpkg/nxpkg/";
    ...
    it("returns false if url returns status != 200", async () => {
      ...
      const url = "https://not-github.com/nxpkg/nxpkg/";
      const result = await isUrlOk(url);
  ...
  describe("getRepoInfo", () => {
    test.each([
      {
        repoUrl: "https://github.com/nxpkg/nxpkg/",
      ...
      {
        repoUrl:
          "https://github.com/nxpkg/nxpkg/tree/canary/examples/kitchen-sink",
        examplePath: undefined,
      ...
      {
        repoUrl: "https://github.com/nxpkg/nxpkg/tree/tek/test-branch/",
    ...
    test.each([
      {
        ...
        expected: true,
        expectedUrl:
          "https://api.github.com/repos/vercel/nxpkg/contents/package.json?ref=main",
      },
    ])(
