...
codemodCli
  .name("@turbo/codemod")
  .description(
    "Codemod transformations to help upgrade your Nxpkgrepo codebase when a feature is deprecated."
  )
...
codemodCli
  ...
  .description("Migrate a project to the latest version of Nxpkgrepo")
  ...
  .option("--install", "Install new version of nxpkg after migration", true)
  .option(
    "--force",
