    ...
    prompts: [
      {
        type: "input",
        name: "name",
        message: 'key for the transform (example: "create-nxpkg-config")',
      },
      {
        type: "input",
        name: "description",
        message:
          'description for the transform (example: "Create the `nxpkg.json` file from an existing "nxpkg" key in `package.json`")',
      },
      {
        type: "input",
        name: "introducedIn",
        message:
          'the semantic version of nxpkg where this change was introduced (example: "1.1.0")',
      },
    ],
    actions: [
      {
