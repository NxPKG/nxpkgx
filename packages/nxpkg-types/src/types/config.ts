...
export interface BaseSchema {
  /** @defaultValue https://nxpkg.build/schema.json */
  $schema?: string;
  /**
   * An object representing the task dependency graph of your project. nxpkg interprets
   * these conventions to schedule, execute, and cache the outputs of tasks in
   * your project.
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#pipeline
   *
   * @defaultValue `{}`
   */
  ...
  pipeline: {
    /**
     * The name of a task that can be executed by nxpkg. If nxpkg finds a workspace
...
export interface WorkspaceSchema extends BaseSchema {
   ...
   * and cannot be used in your root nxpkg.json.
   *
   * Tells nxpkg to extend your root `nxpkg.json`
...
export interface RootSchema extends BaseSchema {
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#globaldependencies
   *
   * @defaultValue []
   */
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#globalenv
   *
   * @defaultValue []
   */
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#globalPassThroughEnv
   *
   * @defaultValue null
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#globalDotEnv
   *
   * @defaultValue null
   */
  ...
  /**
   * Configuration options that control how nxpkg interfaces with the remote cache.
   *
   * Documentation: https://nxpkg.build/repo/docs/core-concepts/remote-caching
   *
   * @defaultValue `{}`
   */
...
export interface Pipeline {
   ...
   *
   * Prefixing an item in dependsOn with a ^ prefix tells nxpkg that this task depends
   ...
   * completed first.")
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#dependson
   *
   * @defaultValue []
   */
   ...
   *
   * Note: If you are migrating from a nxpkg version 1.5 or below,
   * you may be used to prefixing your variables with a $.
   * You no longer need to use the $ prefix.
   * (e.g. $GITHUB_TOKEN → GITHUB_TOKEN)
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#env
   *
   * @defaultValue []
   */
   ...
   * e.g. `AWS_SECRET_KEY`.
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#passThroughEnv
   *
   * @defaultValue null
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#dotEnv
   *
   * @defaultValue null
   */
   ...
   *
   * Nxpkgrepo captures task logs for all tasks. This enables us to cache tasks whose runs
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#outputs
   *
   * @defaultValue []
   */
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#cache
   *
   * @defaultValue true
   */
  cache?: boolean;
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#inputs
   *
   * @defaultValue []
   */
  inputs?: Array<string>;
   ...
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/command-line-reference#--output-logs
   *
   * @defaultValue full
   */
   ...
   * nxpkg that this is a long-running task and will ensure that other tasks
   * cannot depend on it.
   *
   * Documentation: https://nxpkg.build/repo/docs/reference/configuration#persistent
   *
   * @defaultValue false
   */
  persistent?: boolean;
...
export interface RemoteCache {
   ...
   * `true`, Nxpkgrepo will sign every uploaded artifact using the value of the environment
   * variable `NXPKG_REMOTE_CACHE_SIGNATURE_KEY`. Nxpkgrepo will reject any downloaded artifacts
  ...
  /**
   * Indicates if the remote cache is enabled. When `false`, Nxpkgrepo will disable
