...
```sh
npx create-nxpkg@latest -e with-npm
```

## What's inside?

This Nxpkgrepo uses [npm](https://www.npmjs.com/) as a packages manager. It includes the following packages/apps:
