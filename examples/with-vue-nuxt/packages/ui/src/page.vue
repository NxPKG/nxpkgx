...
const LINKS = [
  {
    title: "Docs",
    href: "https://nxpkg.build/repo/docs",
    description: "Find in-depth information about Nxpkgrepo features and API.",
  },
  {
    title: "Learn",
    href: "https://nxpkg.build/repo/docs/handbook",
    description: "Learn more about monorepos with our handbook.",
  },
  {
    title: "Templates",
    href: "https://nxpkg.build/repo/docs/getting-started/from-example",
  ...
  },
  {
    ...
    description:
      " Instantly deploy your Nxpkgrepo to a shareable URL with Vercel.",
  },
];
...
<template>
  <main class="main">
    <div class="description">
      ...
      <div>
        <a
          href="https://vercel.com?utm_source=create-nxpkg&utm_medium=basic&utm_campaign=create-nxpkg"
        ...
        <div class="logos">
          ...
          <div class="logo">
            <img
              ...
              height="120"
              priority
              src="./assets/nxpkgrepo.svg"
              width="120"
            />
          </div>
        </div>
        <Gradient class="backgroundGradient" conic />
        <div class="nxpkgrepoWordmarkContainer">
          <svg
            class="nxpkgrepoWordmark"
            viewBox="0 0 506 50"
            width="200"
            xmlns="http://www.w3.org/2000/svg"
          >
            <title>Nxpkgrepo logo</title>
            <path
