...
use serde_json::json;
use nxpkg_tasks::{trace::TraceRawVcs, Completion, Value, Vc};
use nxpkg_tasks_bytes::stream::SingleValue;
use nxpkg_tasks_fs::{json::parse_json_with_source_context, File, FileContent};
use nxpkgpack_core::{
...
#[nxpkg_tasks::value(transparent, serialization = "custom")]
...
#[derive(Debug, Clone)]
#[nxpkg_tasks::value(shared, transparent)]
