...
const DEBUG_JS_VAR: &str = "NXPKGPACK_DEBUG_JS";

/// Checks if the operation passed is included in the `NXPKGPACK_DEBUG_JS` env
...
pub fn should_debug(operation: &str) -> bool {
    ...
    // This must use nxpkg_tasks_env instead.
