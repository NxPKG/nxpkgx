...
use nxpkg_tasks::Vc;
use nxpkg_tasks_fs::{json::parse_json_with_source_context, FileSystemPath};
use nxpkgpack_ecmascript::magic_identifier::unmangle_identifiers;
...
static MARKER: &[u8] = b"NXPKGPACK_OUTPUT_";
static MARKER_STR: &str = "NXPKGPACK_OUTPUT_";
...
#[nxpkg_tasks::value(into = "new", cell = "new", serialization = "none", eq = "manual")]
