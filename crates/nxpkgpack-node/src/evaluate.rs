...
#[derive(Clone, Debug)]
pub struct JavaScriptEvaluation(#[nxpkg_tasks(trace_ignore)] JavaScriptStream);
...
pub fn evaluate(
    ...
    let cell = nxpkg_tasks::macro_helpers::find_cell_by_type(*JAVASCRIPTEVALUATION_VALUE_TYPE_ID);
