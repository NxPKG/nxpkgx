...
use crate::{
    ...
    util::SharedError,
    ConcreteTaskInput, {self as nxpkg_tasks},
};

/// A native (rust) nxpkg-tasks function. It's used internally by
/// `#[nxpkg_tasks::function]`.
#[nxpkg_tasks::value(cell = "new", serialization = "none", eq = "manual")]
