    ...
    T: VcValueType,
{
    ...
    /// `Completion`. When using `#[nxpkg_tasks::value(transparent)]`, the
...
/// Representation for standard `#[nxpkg_tasks::value]`, where a read return a
...
/// Representation for `#[nxpkg_tasks::value(transparent)]` types, where reads
    ...
    Repr: VcValueType,
{
    ...
    fn value_to_target_ref(value: &T) -> &Self::Target {
        ...
        // `#[nxpkg_tasks::value(transparent)]` macro.
