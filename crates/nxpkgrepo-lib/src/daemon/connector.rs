...
use super::{client::proto::nxpkgd_client::NxpkgdClient, DaemonClient};
...
pub struct DaemonConnector {
    ...
    pub pid_file: nxpkgpath::AbsoluteSystemPathBuf,
    pub sock_file: nxpkgpath::AbsoluteSystemPathBuf,
}
...
impl DaemonConnector {
    ...
    async fn get_connection(
        &self,
        path: nxpkgpath::AbsoluteSystemPathBuf,
    ) -> Result<NxpkgdClient<tonic::transport::Channel>, DaemonConnectorError> {
...
#[cfg(target_os = "windows")]
fn win(
    path: Arc<nxpkgpath::AbsoluteSystemPathBuf>,
...
pub enum FileWaitError {
    ...
    InvalidPath(nxpkgpath::AbsoluteSystemPathBuf),
}
...
mod test {
    ...
    fn pid_path(tmp_path: &Path) -> AbsoluteSystemPathBuf {
        AbsoluteSystemPathBuf::try_from(tmp_path.join("nxpkgd.pid")).unwrap()
    }

    fn sock_path(tmp_path: &Path) -> AbsoluteSystemPathBuf {
        AbsoluteSystemPathBuf::try_from(tmp_path.join("nxpkgd.sock")).unwrap()
    }
    ...
    #[tonic::async_trait]
    impl proto::nxpkgd_server::Nxpkgd for DummyServer {
        async fn shutdown(
            &self,
    ...
    async fn handles_kill_live_server() {
        ...
        let server_fut = tonic::transport::Server::builder()
            .add_service(proto::nxpkgd_server::NxpkgdServer::new(DummyServer {
