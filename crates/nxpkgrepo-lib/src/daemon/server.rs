...
/// run a gRPC server providing the Nxpkgd interface. external_shutdown
    ...
    S: Future<Output = CloseReason>,
{
    ...
    let server_fut = {
        let service = ServiceBuilder::new()
            ...
            .service(crate::daemon::proto::nxpkgd_server::NxpkgdServer::new(
                service,
            ));
    ...
    // Now that the server has exited, the NxpkgGrpcService instance should be
...
#[tonic::async_trait]
impl proto::nxpkgd_server::Nxpkgd for NxpkgGrpcService {
    async fn hello(
        &self,
...
impl NamedService for NxpkgGrpcService {
    const NAME: &'static str = "nxpkgrepo.Daemon";
}
...
mod test {
    ...
    async fn lifecycle() {
        ...
        let pid_path = daemon_root.join_component("nxpkgd.pid");
