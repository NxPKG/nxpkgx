...
use crate::{
    config::{ConfigurationOptions, Error as ConfigError, NxpkgrepoConfigBuilder},
    Args,
};
...
impl CommandBase {
    ...
    fn config_init(&self) -> Result<ConfigurationOptions, ConfigError> {
        NxpkgrepoConfigBuilder::new(self)
    ...
    /// Current working directory for the nxpkg command
...
mod test {
    ...
    #[test_case("/tmp/nxpkgrepo", "6e0cfa616f75a61c"; "basic example")]
    ...
    #[test_case("C:\\\\tmp\\nxpkgrepo", "0103736e6883e35f"; "basic example")]
