...
mod test {
    ...
    fn test_resolve_package() -> Result<(), Error> {
        ...
        let tests = [
            ("", "nxpkg", "node_modules/nxpkg", "1.5.5"),
            (
                "apps/web",
                "lodash",
    ...
    fn test_all_dependencies() -> Result<(), Error> {
        ...
        let tests = [
            ...
            (
                "node_modules/nxpkg",
                vec![
                    "node_modules/nxpkg-darwin-64",
                    "node_modules/nxpkg-darwin-arm64",
                    "node_modules/nxpkg-linux-64",
                    "node_modules/nxpkg-linux-arm64",
                    "node_modules/nxpkg-windows-64",
                    "node_modules/nxpkg-windows-arm64",
                ],
            ),
            (
    ...
    fn test_workspace_peer_dependencies() -> Result<(), Error> {
        ...
        let closures = crate::all_transitive_closures(
            ...
            vec![
                (
                    "packages/a".into(),
                    vec![("eslint-plugin-nxpkg".into(), "^1.9.3".into())]
                        .into_iter()
                        .collect(),
                ),
        ...
        assert!(closures.get("packages/a").unwrap().contains(&Package {
            key: "node_modules/eslint-plugin-nxpkg".into(),
            version: "1.9.3".into()
        }));
