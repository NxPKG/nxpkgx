...
pub use references::{AnalyzeEcmascriptModuleResult, NXPKGPACK_HELPER};
...
use nxpkg_tasks::{trace::TraceRawVcs, ReadRef, TryJoinIterExt, Value, ValueToString, Vc};
use nxpkg_tasks_fs::{rope::Rope, FileSystemPath};
use nxpkgpack_core::{
...
pub struct EcmascriptModuleAsset {
    ...
    #[serde(skip)]
    last_successful_analysis: nxpkg_tasks::State<Option<MemoizedSuccessfulAnalysis>>,
}
