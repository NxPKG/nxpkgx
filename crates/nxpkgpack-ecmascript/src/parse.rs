...
use nxpkg_tasks::{util::WrapFuture, Value, ValueToString, Vc};
use nxpkg_tasks_fs::{FileContent, FileSystemPath};
use nxpkg_tasks_hash::hash_xxh3_hash64;
use nxpkgpack_core::{
...
#[nxpkg_tasks::value(shared, serialization = "none", eq = "manual")]
...
impl GenerateSourceMap for ParseResultSourceMap {
    ...
    fn generate_source_map(&self) -> Vc<OptionSourceMap> {
        ...
        Vc::cell(Some(
            nxpkgpack_core::source_map::SourceMap::new_regular(map).cell(),
        ))
    }
}
