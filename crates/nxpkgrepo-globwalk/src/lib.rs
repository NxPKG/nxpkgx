...
use nxpkgpath::{AbsoluteSystemPath, AbsoluteSystemPathBuf, PathError};
...
mod test {
    ...
    #[test_case(&[
            ...
            "/repos/some-app/.nxpkg/nxpkg-build.log",
            "/repos/some-app/.nxpkg/somebody-touched-this-file-into-existence.txt",
        ...
        "/repos/some-app/",
        &[".nxpkg/nxpkg-build.log", "dist/**", ".next/**", "public/dist/**"],
        &[],
        &[
            "/repos/some-app/.next",
