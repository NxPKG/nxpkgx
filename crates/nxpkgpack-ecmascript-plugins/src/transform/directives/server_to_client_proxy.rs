...
use nxpkgpack_ecmascript::NXPKGPACK_HELPER;
        ...
        body: vec![
            ModuleItem::Stmt(Stmt::Expr(ExprStmt {
                expr: Box::new(Expr::Lit(Lit::Str(Str {
                    value: format!("NXPKGPACK {{ transition: {transition_name} }}").into(),
                    raw: None,
                    span: DUMMY_SP,
                }))),
                span: DUMMY_SP,
            ...
            ModuleItem::ModuleDecl(ModuleDecl::Import(ImportDecl {
                ...
                with: Some(Box::new(ObjectLit {
                    ...
                    props: vec![PropOrSpread::Prop(Box::new(Prop::KeyValue(KeyValueProp {
                        key: PropName::Ident(Ident::new(NXPKGPACK_HELPER.into(), DUMMY_SP)),
            ...
            ModuleItem::Stmt(quote!(
                "__nxpkgpack_export_namespace__($proxy);" as Stmt,
                proxy = ident,
            )),
        ],
        shebang: None,
