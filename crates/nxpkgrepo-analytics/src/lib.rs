...
use tracing::debug;
use nxpkgrepo_api_client::{analytics::AnalyticsClient, APIAuth};
pub use nxpkgrepo_vercel_api::AnalyticsEvent;
use uuid::Uuid;
...
mod tests {
    ...
    use nxpkgrepo_api_client::{analytics::AnalyticsClient, APIAuth};
    use nxpkgrepo_vercel_api::{AnalyticsEvent, CacheEvent, CacheSource};
    ...
    impl AnalyticsClient for DummyClient {
        ...
        ) -> Result<(), nxpkgrepo_api_client::Error> {
