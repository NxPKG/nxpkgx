declare const __nxpkgpack_external_require__: (id: string) => any;
const jest = __nxpkgpack_external_require__("jest-circus");
const expectMod = __nxpkgpack_external_require__("expect");
