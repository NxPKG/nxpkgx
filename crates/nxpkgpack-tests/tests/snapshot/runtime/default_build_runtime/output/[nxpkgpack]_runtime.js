const RUNTIME_PUBLIC_PATH = "output/[nxpkgpack]_runtime.js";
const OUTPUT_ROOT = "crates/nxpkgpack-tests/tests/snapshot/runtime/default_build_runtime";
const ASSET_PREFIX = "";
/**
 ...
 * `__dirname` or `import.meta.url` that Nxpkgpack will not embeds in compile time.
