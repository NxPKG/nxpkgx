(globalThis.NXPKGPACK = globalThis.NXPKGPACK || []).push([
    "output/79fb1_nxpkgpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_40d141.js",
    {},
    {"otherChunks":["output/79fb1_nxpkgpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_7e4b32.js"],"runtimeModuleIds":["[project]/crates/nxpkgpack-tests/tests/snapshot/runtime/default_dev_runtime/input/index.js [test] (ecmascript)"]}
]);
(() => {
if (!Array.isArray(globalThis.NXPKGPACK)) {
    return;
}
...
const nxpkgpackQueues = Symbol("nxpkgpack queues");
const nxpkgpackExports = Symbol("nxpkgpack exports");
const nxpkgpackError = Symbol("nxpkgpack error");
    ...
    return deps.map((dep)=>{
        if (dep !== null && typeof dep === "object") {
            ...
            if (isPromise(dep)) {
                ...
                const obj = {
                    [nxpkgpackExports]: {},
                    [nxpkgpackQueues]: (fn)=>fn(queue)
                };
                dep.then((res)=>{
                    obj[nxpkgpackExports] = res;
                    resolveQueue(queue);
                }, (err)=>{
                    obj[nxpkgpackError] = err;
                    resolveQueue(queue);
                });
                return obj;
            }
...
function asyncModule(module, body, hasAwait) {
    ...
    function handleAsyncDependencies(deps) {
        ...
        const getResult = ()=>currentDeps.map((d)=>{
                if (d[nxpkgpackError]) throw d[nxpkgpackError];
                return d[nxpkgpackExports];
            });
        ...
        currentDeps.map((dep)=>dep[nxpkgpackQueues](fnQueue));
        return fn.queueCount ? promise : getResult();
    }
    function asyncResult(err) {
        if (err) {
            reject(promise[nxpkgpackError] = err);
        } else {
            resolve(exports);
        }
        resolveQueue(queue);
...
/**
 * This file contains runtime types and functions that are shared between all
 * Nxpkgpack *development* ECMAScript runtimes.
 *
...
function createModuleHot(moduleId, hotData) {
    ...
    const hot = {
        ...
        // want the webpack code paths to ever update (the nxpkgpack paths handle
        // this already).
...
globalThis.NXPKGPACK_CHUNK_UPDATE_LISTENERS ??= [];
const chunkListsToRegister = globalThis.NXPKGPACK_CHUNK_LISTS;
if (Array.isArray(chunkListsToRegister)) {
    for (const chunkList of chunkListsToRegister){
        registerChunkList(globalThis.NXPKGPACK_CHUNK_UPDATE_LISTENERS, chunkList);
    }
}
globalThis.NXPKGPACK_CHUNK_LISTS = {
    push: (chunkList)=>{
        registerChunkList(globalThis.NXPKGPACK_CHUNK_UPDATE_LISTENERS, chunkList);
    }
};
/**
 * This file contains the runtime code specific to the Nxpkgpack development
...
const chunksToRegister = globalThis.NXPKGPACK;
globalThis.NXPKGPACK = { push: registerChunk };
chunksToRegister.forEach(registerChunk);
})();


//# sourceMappingURL=79fb1_nxpkgpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_40d141.js.map