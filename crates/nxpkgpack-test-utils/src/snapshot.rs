...
use nxpkg_tasks::{ReadRef, TryJoinIterExt, ValueToString, Vc};
use nxpkg_tasks_fs::{
    DirectoryContent, DirectoryEntry, DiskFileSystem, File, FileContent, FileSystemEntryType,
    FileSystemPath,
};
use nxpkg_tasks_hash::encode_hex;
use nxpkgpack_cli_utils::issue::{format_issue, LogOptions};
use nxpkgpack_core::{
    asset::AssetContent,
...
// e.g. `UPDATE=1 cargo test -p nxpkgpack-tests -- test_my_pattern`
