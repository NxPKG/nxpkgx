...
use nxpkg_tasks::{Value, ValueDefault, Vc};
use nxpkg_tasks_fs::{rope::Rope, File, FileContent, FileSystemPath};
use nxpkgpack_core::{
...
/// Subset of mdxjs::Options to allow to inherit nxpkgpack's jsx-related configs
/// into mdxjs.
