...
React.useEffect(() => {
    if (EFFECT_PROPS.hydration) {
        globalThis.__nxpkgpackBenchBinding && globalThis.__nxpkgpackBenchBinding("Hydration done");
    }
    if (EFFECT_PROPS.message) {
        globalThis.__nxpkgpackBenchBinding && globalThis.__nxpkgpackBenchBinding(EFFECT_PROPS.message);
    }
}, [EFFECT_PROPS]);
"#};
                ...
                return (
                    <html lang="en">
                        <head>
                            ...
                            <title>Nxpkgpack Test App</title>
                        </head>
                        <body>
                            {children}
                        </body>
