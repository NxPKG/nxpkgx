...
/// ## Arguments
///
/// Example: `#[nxpkg_tasks::value(into = "new", eq = "manual")]`
///
/// ### `cell`
///
/// Possible values:
...
/// No value.
///
/// Example: `#[nxpkg_tasks::value(shared)]`
///
/// ### `transparent`
///
...
/// No value.
///
/// Example: `#[nxpkg_tasks::value(transparent)]`
///
...
///
/// ```
/// use crate::generic_type as __nxpkg_tasks_internal_generic_type;
///
/// __nxpkg_tasks_internal_generic_type!(<A, B>, GenericType<Vc<A>, Vc<B>>);
///
