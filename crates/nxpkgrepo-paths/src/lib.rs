...
/// Nxpkgrepo's path handling library
/// Defines distinct path types for the different usecases of paths in nxpkgrepo
///
...
/// recommended is inside nxpkgpath itself. But that unchecked initialization
