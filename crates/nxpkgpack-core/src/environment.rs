...
#[derive(Default)]
pub struct ServerAddr(#[nxpkg_tasks(trace_ignore)] Option<SocketAddr>);
...
/// A simple serializable structure meant to carry information about Nxpkgpack's
...
pub struct RuntimeVersions(#[nxpkg_tasks(trace_ignore)] pub Versions);
