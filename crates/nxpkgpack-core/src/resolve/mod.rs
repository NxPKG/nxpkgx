...
use tracing::Level;
use nxpkg_tasks::{TryJoinIterExt, Value, ValueToString, Vc};
use nxpkg_tasks_fs::{
...
enum ExportsFieldResult {
    Some(#[nxpkg_tasks(debug_ignore, trace_ignore)] ExportsField),
    None,
}
...
enum ImportsFieldResult {
    Some(
        #[nxpkg_tasks(debug_ignore, trace_ignore)] ImportsField,
        Vc<FileSystemPath>,
    ),
    None,
}
