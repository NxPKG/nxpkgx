...
use nxpkg_tasks::{Completion, Value, Vc};
...
use nxpkgpack_json::JsonModuleAsset;
use nxpkgpack_mdx::MdxModuleAsset;
use nxpkgpack_static::StaticModuleAsset;
use nxpkgpack_wasm::{module_asset::WebAssemblyModuleAsset, source::WebAssemblySource};
...
pub fn register() {
    ...
    nxpkgpack_css::register();
    nxpkgpack_ecmascript::register();
    nxpkgpack_node::register();
    nxpkgpack_env::register();
    nxpkgpack_mdx::register();
    nxpkgpack_json::register();
    nxpkgpack_static::register();
    nxpkgpack_wasm::register();
