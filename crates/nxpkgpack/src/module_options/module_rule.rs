...
use nxpkg_tasks::{trace::TraceRawVcs, Vc};
use nxpkg_tasks_fs::FileSystemPath;
use nxpkgpack_core::{
    reference_type::ReferenceType, source::Source, source_transform::SourceTransforms,
};
use nxpkgpack_css::{CssInputTransforms, CssModuleAssetType};
use nxpkgpack_ecmascript::{EcmascriptInputTransforms, EcmascriptOptions};
...
#[nxpkg_tasks::value(serialization = "auto_for_input", shared)]
