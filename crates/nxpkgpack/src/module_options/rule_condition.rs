...
use nxpkg_tasks::{primitives::Regex, trace::TraceRawVcs, ReadRef, Vc};
...
pub enum ModuleRuleCondition {
    ...
    ResourcePathRegex(#[nxpkg_tasks(trace_ignore)] Regex),
    ...
    ResourceBasePathGlob(#[nxpkg_tasks(trace_ignore)] ReadRef<Glob>),
}
