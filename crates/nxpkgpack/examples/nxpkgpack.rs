...
use nxpkg_tasks::{util::FormatDuration, NxpkgTasks, NxpkgTasksBackendApi, UpdateInfo, Value, Vc};
use nxpkg_tasks_fs::{DiskFileSystem, FileSystem};
...
async fn main() -> Result<()> {
    ...
    let task = tt.spawn_root_task(|| {
        Box::pin(async {
            ...
            let module_asset_context = nxpkgpack::ModuleAssetContext::new(
                Vc::cell(HashMap::new()),
