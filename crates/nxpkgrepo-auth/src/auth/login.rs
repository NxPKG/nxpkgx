...
use nxpkgrepo_ui::{start_spinner, BOLD, UI};
...
mod tests {
    ...
    impl LoginServer for MockLoginServer {
        async fn run(
            ...
            login_token
                .set(nxpkgrepo_vercel_api_mock::EXPECTED_TOKEN.to_string())
                .unwrap();
            Ok(())
        }
    }
    ...
    impl From<MockApiError> for nxpkgrepo_api_client::Error {
        fn from(error: MockApiError) -> Self {
            match error {
                MockApiError::EmptyToken => nxpkgrepo_api_client::Error::UnknownStatus {
    ...
    impl Client for MockApiClient {
        async fn get_user(&self, token: &str) -> nxpkgrepo_api_client::Result<UserResponse> {
            if token.is_empty() {
        ...
        async fn get_teams(&self, token: &str) -> nxpkgrepo_api_client::Result<TeamsResponse> {
            if token.is_empty() {
                return Err(MockApiError::EmptyToken.into());
            }
        ...
        async fn get_team(
            ...
            _token: &str,
            _team_id: &str,
        ) -> nxpkgrepo_api_client::Result<Option<Team>> {
        ...
        ) -> nxpkgrepo_api_client::Result<CachingStatusResponse> {
        ...
        async fn get_spaces(
            ...
            _token: &str,
            _team_id: Option<&str>,
        ) -> nxpkgrepo_api_client::Result<SpacesResponse> {
        ...
        async fn verify_sso_token(
            ...
            token: &str,
            _: &str,
        ) -> nxpkgrepo_api_client::Result<VerifiedSsoUser> {
            Ok(VerifiedSsoUser {
        ...
        async fn put_artifact(
            ...
            _tag: Option<&str>,
            _token: &str,
        ) -> nxpkgrepo_api_client::Result<()> {
            unimplemented!("put_artifact")
        }
        async fn handle_403(_response: Response) -> nxpkgrepo_api_client::Error {
        ...
        async fn fetch_artifact(
            ...
            _team_id: Option<&str>,
            _team_slug: Option<&str>,
        ) -> nxpkgrepo_api_client::Result<Option<Response>> {
        ...
        ) -> nxpkgrepo_api_client::Result<PreflightResponse> {
    ...
    async fn test_login() {
        ...
        assert_eq!(
            got_token.as_deref(),
            Some(nxpkgrepo_vercel_api_mock::EXPECTED_TOKEN)
        );
