...
fn get_token_and_redirect(payload: SsoPayload) -> Result<(Option<String>, Url), Error> {
    let location_stub = "https://vercel.com/notifications/cli-login/nxpkg/";
...
mod tests {
    ...
    fn test_get_token_and_redirect() {
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://vercel.com/notifications/cli-login/nxpkg/success").unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://vercel.com/notifications/cli-login/nxpkg/failed?loginError=error"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://vercel.com/notifications/cli-login/nxpkg/incomplete?ssoEmail=email"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://vercel.com/notifications/cli-login/nxpkg/incomplete?ssoEmail=email&teamName=team")
                    .unwrap()
            )
        );
