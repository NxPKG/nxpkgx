//! Testing utilities and macros for nxpkg-tasks and applications based on it.
...
use nxpkg_tasks::{
    ...
    registry,
    test_helpers::with_nxpkg_tasks_for_testing,
    util::{SharedError, StaticOrArc},
    CellId, InvalidationReason, RawVc, TaskId, TraitTypeId, NxpkgTasksApi, NxpkgTasksCallApi,
};
...
impl NxpkgTasksCallApi for VcStorage {
    fn dynamic_call(
        &self,
        func: nxpkg_tasks::FunctionId,
        inputs: Vec<nxpkg_tasks::ConcreteTaskInput>,
    ) -> RawVc {
        ...
        handle.spawn(with_nxpkg_tasks_for_testing(this.clone(), id, async move {
    ...
    fn native_call(
        &self,
        _func: nxpkg_tasks::FunctionId,
        _inputs: Vec<nxpkg_tasks::ConcreteTaskInput>,
    ) -> RawVc {
        unreachable!()
    }
    ...
    fn trait_call(
        &self,
        _trait_type: nxpkg_tasks::TraitTypeId,
...
impl NxpkgTasksApi for VcStorage {
    ...
    fn invalidate_with_reason(
        &self,
        _task: TaskId,
        _reason: nxpkg_tasks::util::StaticOrArc<dyn nxpkg_tasks::InvalidationReason>,
    ) {
        unreachable!()
    }
    ...
    fn emit_collectible(&self, _trait_type: nxpkg_tasks::TraitTypeId, _collectible: RawVc) {
        unimplemented!()
    }
