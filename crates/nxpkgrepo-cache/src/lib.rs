...
pub enum CacheError {
    ...
    ApiClientError(Box<nxpkgrepo_api_client::Error>, #[backtrace] Backtrace),
    ...
    PathError(#[from] nxpkgpath::PathError, #[backtrace] Backtrace),
...
impl From<nxpkgrepo_api_client::Error> for CacheError {
    fn from(value: nxpkgrepo_api_client::Error) -> Self {
