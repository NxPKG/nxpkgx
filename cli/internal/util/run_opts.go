...
const (
	// Infer - infer environment variable constraints from nxpkg.json
	Infer EnvMode = "Infer"
...
// RunOpts holds the options that control the execution of a nxpkg run
type RunOpts struct {
	...
	// Whether nxpkg should create a run summary
	Summarize bool
