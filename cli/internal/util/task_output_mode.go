...
// TaskOutputMode defines the ways nxpkg can display task output during a run
...
const (
	...
	NoTaskOutput
	// HashTaskOutput will display nxpkg-computed task hashes
	HashTaskOutput
	// NewTaskOutput will show all new task output and nxpkg-computed task hashes for cached output
	NewTaskOutput
